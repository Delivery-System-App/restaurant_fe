...
const BookingDetails = ({ bookid }) => {
  ...
  return (
    <div>
      <BackButton />
      <br /> <br />
      <h1>Booking details of {bookid}</h1>
      <br />
      <br />
      <Card>
        <CardContent>
          <h1>
            Booking ID:{" "}
            <span className="text-gray-500 whitespace-no-wrap">{bookid}</span>
          </h1>
          <br />
          <br />
          <h1>
            ...
            <span className="text-gray-500 whitespace-no-wrap">
              {details.data?.deliveryStatus}
            </span>
          </h1>
          <h1>
            Payment Status:{" "}
            <span className="text-gray-500 whitespace-no-wrap">
              {details.data?.payStatus}
            </span>
          </h1>
          <h1>
            Cancel Status:{" "}
            <span className="text-gray-500 whitespace-no-wrap">
              {details.data?.cancelStatus}
            </span>
          </h1>
          <br />
          <br />
